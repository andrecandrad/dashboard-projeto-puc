				  ...
				  <div className="relative w-auto my-6 mx-auto max-w-3xl">
					  <div
					   className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
						  <div
						   className="flex  justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
						  ...
						  {loading ? (
						   ...
						   <>
							   {activeForm && (
								<div
								 className="text-center flex-row pl-7 pr-7 border-b border-solid border-blueGray-200 rounded-t">
									...
									<div
									 className="flex items-center justify-end pt-4 pb-4 pl-4 border-t border-solid border-blueGray-200 rounded-b">
							   ...
							   {hasData === true && (
								...
								<div
								 className="flex items-center justify-between pt-4 border-t border-solid border-blueGray-200 rounded-b">
									{activeForm === false && (
									 <div className="flex items-center justify-start">
										 <button
										  className="text-gray-500 background-transparent font-bold uppercase text-sm outline-none focus:outline-none ease-linear transition-all duration-150"
										  type="button" onClick={handleTurnBack}>
											 Voltar
										 </button>
									 </div>
									)}
								...
								<div className="relative p-6 flex-auto">
									<form onSubmit={getFile}>
										<div className="mb-4">
											...
											<input type="text" id="nameUpload"
											       className="shadow appearance-none border rounded w-1/2 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
											       value={nameCondominio} onChange={handleNameChange}/>
											<label className="block text-gray-700 text-sm font-bold mb-2"
											       htmlFor="upload">
												Upload PDF
											</label>
